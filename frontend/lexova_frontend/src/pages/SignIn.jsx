      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <div className="text-xs text-blue-800 space-y-1">
            <p><strong>Admin:</strong> ethan@lexova.com / LexovaAdmin2024!</p>
            <p><strong>Client:</strong> client1@example.com / ClientPass123!</p>
            <p><strong>Lawyer:</strong> lawyer1@example.com / LawyerPass123!</p>
          </div>
        </div>
      </div>
    </div>
